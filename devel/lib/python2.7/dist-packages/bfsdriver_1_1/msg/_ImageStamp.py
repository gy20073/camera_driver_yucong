...
"""autogenerated by genpy from bfsdriver_1_1/ImageStamp.msg. Do not edit."""
import sys
...
class ImageStamp(genpy.Message):
  _md5sum = "a883a9426baf2a438022495173b1e3df"
  _type = "bfsdriver_1_1/ImageStamp"
...
"""
  ...
  _slot_types = ['sensor_msgs/Image','uint64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageStamp, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_Q().pack(self.timestamp))
