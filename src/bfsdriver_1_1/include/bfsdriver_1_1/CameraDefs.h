...
/* Generated Wed Jun 14 16:31:58 2017 */
...
namespace Spinnaker
{
	...
	*/
	...
	enum DeviceIndicatorModeEnums	/*!< Controls the behavior of the indicators (such as LEDs) showing the status of the Device.*/
	{
	...
	enum BinningHorizontalModeEnums	/*!< Sets the mode to use to combine horizontal photo-sensitive cells together when BinningHorizontal is used.*/
	{
	...
	enum BinningVerticalModeEnums	/*!< Sets the mode used to combine horizontal photo-sensitive cells together when BinningVertical is used.*/
	{
	...
	enum DecimationHorizontalModeEnums	/*!< Sets the mode used to reduce the horizontal resolution when DecimationHorizontal is used.*/
	{
	...
	enum DecimationVerticalModeEnums	/*!< Sets the mode used to reduce the Vertical resolution when DecimationVertical is used.*/
	{
	...
	enum PixelFormatEnums	/*!< Format of the pixels provided by the device. It represents all the information provided by PixelSize, PixelColorFilter combined in a single feature.*/
	{
		...
		PixelFormat_Mono10Packed,	/*!< Pixel format set Mono 10 Packed.*/
		...
		PixelFormat_BayerGB12Packed,	/*!< Pixel format set to BayerGB 12 Packed. (GigE Vision 2.0)*/
		PixelFormat_BayerBG12Packed,	/*!< Pixel format set to BayerBG 12 Packed. (GigE Vision 2.0)*/
		PixelFormat_YUV411Packed,	/*!< Pixel format set to YUV411 Packed.*/
		PixelFormat_YUV422Packed,	/*!< Pixel format set to YUV 422 Packed.*/
		PixelFormat_YUV444Packed,	/*!< Pixel format set to YUV 444 Packed.*/
		PixelFormat_RGB8Packed,	/*!< Pixel format set to RGB 8 Packed.*/
	...
	enum PixelColorFilterEnums	/*!< Type of color filter that is applied to the image.*/
	{
	...
	enum AcquisitionModeEnums	/*!< Sets the acquisition mode of the device. It defines mainly the number of frames to capture during an acquisition and the way the acquisition stops.*/
	{
	...
	enum TriggerModeEnums	/*!< Controls if the selected trigger is active.*/
	{
	...
	enum TriggerSourceEnums	/*!< Specifies the internal signal or physical input Line to use as the trigger source. The selected trigger must have its TriggerMode set to On.*/
	{
	...
	enum TriggerOverlapEnums	/*!< Specifies the type trigger overlap permitted with the previous frame or line. This defines when a valid trigger will be accepted (or latched) for a new frame or a new line.*/
	{
	...
	enum ExposureAutoEnums	/*!< Sets the automatic exposure mode when ExposureMode is Timed. The exact algorithm used to implement this control is device-specific.*/
	{
	...
	enum GainSelectorEnums	/*!< Selects which Gain is controlled by the various Gain features.*/
	{
	...
	enum GainAutoEnums	/*!< Sets the automatic gain control (AGC) mode. The exact algorithm used to implement AGC is device-specific.*/
	{
	...
	enum BlackLevelSelectorEnums	/*!< Selects which Black Level is controlled by the various Black Level features.*/
	{
	...
	enum BalanceRatioSelectorEnums	/*!< Selects which Balance ratio to control.*/
	{
	...
	enum BalanceWhiteAutoEnums	/*!< Controls the mode for automatic white balancing between the color channels. The white balancing ratios are automatically adjusted.*/
	{
	...
	enum LineSelectorEnums	/*!< Selects the physical line (or pin) of the external device connector or the virtual line of the Transport Layer to configure.*/
	{
	...
	enum LineFormatEnums	/*!< Controls the current electrical format of the selected physical input or output Line.*/
	{
	...
	enum UserOutputSelectorEnums	/*!< Selects which bit of the User Output register will be set by UserOutputValue.*/
	{
	...
	enum CounterEventSourceEnums	/*!< Select the events that will be the source to increment the Counter.*/
	{
	...
	enum CounterEventActivationEnums	/*!< Selects the Activation mode Event Source signal.*/
	{
	...
	enum CounterResetSourceEnums	/*!< Selects the signals that will be the source to reset the Counter.*/
	{
	...
	enum CounterTriggerSourceEnums	/*!< Selects the source to start the Counter.*/
	{
	...
	enum EventSelectorEnums	/*!< Selects which Event to signal to the host application.*/
	{
	...
	enum EventNotificationEnums	/*!< Activate or deactivate the notification to the host application of the occurrence of the selected Event.*/
	{
	...
	enum UserSetFeatureSelectorEnums	/*!< Selects which individual UserSet feature to control.*/
	{

		NUM_USERSETFEATURESELECTOR
	};

	enum SequencerModeEnums	/*!< Controls if the sequencer mechanism is active.*/
	{
	...
	enum SequencerConfigurationModeEnums	/*!< Controls if the sequencer configuration mode is active.*/
	{
	...
	enum FileSelectorEnums	/*!< Selects the target file in the device.*/
	{
	...
	enum FileOperationSelectorEnums	/*!< Selects the target operation for the selected file in the device. This Operation is executed when the FileOperationExecute feature is called.*/
	{
	...
	enum FileOpenModeEnums	/*!< Selects the access mode in which a file is opened in the device.*/
	{
	...
	enum ChunkSelectorEnums	/*!< Selects which Chunk to enable or control.*/
	{
	...
	enum ChunkPixelFormatEnums	/*!< Returns the PixelFormat of the image included in the payload.*/
	{
	...
	enum ChunkGainSelectorEnums	/*!< Selects which Gain to return.*/
	{
	...
	enum ChunkBlackLevelSelectorEnums	/*!< Selects which Black Level to return. Possible values are:*/
	{
